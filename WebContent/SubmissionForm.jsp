...
<body>
	...
	<br>
	<a href="http://localhost:8080/homework2/Submissions?course=${param.course}&assignment=${param.assignment}">${param.assignment}</a>
	<h3>Create Submission</h3>
	<form action="http://localhost:8080/homework2/Submissions?course=${param.course}&assignment=${param.assignment}" method="post">
